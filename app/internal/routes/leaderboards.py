...
async def fetch_data_from_external_api(q_param: dict, headers: dict):
    async with httpx.AsyncClient() as client:
        response = await client.get("https://open.faceit.com/data/v4/leaderboards/651da31af3e96d2044a35366",
...
async def get_leaderboard(offset: int, limit: int = 20):
    ...
    return await fetch_data_from_external_api(q_param=q_param, headers=headers)
